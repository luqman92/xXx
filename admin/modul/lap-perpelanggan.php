...
<div class="row">
    <div class="col-md-12">
        <h1 class="page-head-line">LAPORAN PER PELANGGAN</h1>
        <h1 class="page-subhead-line">
            <ol class="breadcrumb">
                <li><a style="text-decoration: none;" href="./">Home</a></li>
                <li class="active">Laporan Per Pelanggan</li>
            </ol>
        </h1>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <table class="table table-responsive" id="lap-bulanan">
            ...
            $totAng = 0;
            $Lap = new Laporan();
            $arrayLapBulanan = $Lap->tampilLapPerpelangganFilter($_POST['tgl_awal'],$_POST['tgl_akhir']);
